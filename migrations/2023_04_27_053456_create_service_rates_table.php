...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('service_rates', function (Blueprint $table) {
            ...
            $table->integer('per_meter_flat_rate_fee')->default(0);
            $table->string('per_meter_unit')->nullable();
            $table->string('algorithm')->nullable();
            $table->string('rate_calculation_method')->nullable();
            $table->integer('has_cod_fee')->default(0);
            $table->string('cod_calculation_method')->nullable();
            $table->integer('cod_flat_fee')->default(0);
            $table->integer('cod_percent')->default(0);
            $table->integer('has_peak_hours_fee')->default(0);
            $table->string('peak_hours_calculation_method')->nullable();
            $table->integer('peak_hours_flat_fee')->default(0);
            $table->integer('peak_hours_percent')->default(0);
